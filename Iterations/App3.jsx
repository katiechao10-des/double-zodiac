...
// Frame paths: 01.jpg through 11.jpg in /public/frames/
const FRAME_PATHS = Array.from({ length: 11 }, (_, i) =>
...
export default function App() {
  ...
  function handleEnvelopeClick() {
    ...
    if (phase === PHASE.ENVELOPE) {
      // Flip envelope from front to back
      animateFrames(0, 4, () => setPhase(PHASE.BIRTHDAY));
    }
  }
