...
style.textContent = `
  ...
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  .result-west-label { color: var(--pale-gold); }
  .result-east-label { color: var(--red); opacity: 0.9; }
  ...
  .result-footer a { color: var(--gold); text-decoration: none; }
