...
style.textContent = `
  ...
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  body {
    background: url('/desktopBackground.png') center top / cover no-repeat fixed;
    color: var(--ink);
  ...
  .monitor-screen {
    position: fixed;
    /* These percentages position the content area over the monitor screen in the background image */
    /* You will need to fine-tune these values */
    left: 15.9%;
    top: 14.2%;
    width: 67%;
    height: 49%;
